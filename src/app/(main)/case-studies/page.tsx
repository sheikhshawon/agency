      ...
      <section className="pb-24">
        {caseStudies.length === 0 ? (
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center py-16">
            <p className="text-[#606060]">No case studies published yet. Check back soon.</p>
          </div>
        ) : (
            ...
            {caseStudies.map((cs) => (
              ...
              >
                <div className="aspect-[16/7] bg-[#111111] relative overflow-hidden">
                  ...
                  {cs.industry && (
                    <div className="absolute top-4 left-4 px-3 py-1.5 rounded-full bg-[#1B6BFF]/15 border border-[#1B6BFF]/25 text-[#1B6BFF] text-xs font-semibold backdrop-blur-sm">
                      {cs.industry}
                    </div>
                  )}
                  {cs.metric && (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {cs.challenge && (
                      <div>
                        ...
                        <p className="text-sm text-[#606060] leading-relaxed line-clamp-4">{cs.challenge}</p>
                      </div>
                    )}
                    {cs.solution && (
                      <div>
                        <p className="text-xs font-semibold text-[#808080] uppercase tracking-wider mb-1.5">Solution</p>
                        <p className="text-sm text-[#606060] leading-relaxed line-clamp-4">{cs.solution}</p>
                      </div>
                    )}
                  </div>
